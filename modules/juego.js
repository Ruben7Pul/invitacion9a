...
export function initJuego(config) {
  console.log('🎮 Iniciando juego (sin tiempo, mouse, 18 puntos, colisión corregida)');
  ...
  function checkAndRegenerate() {
    ...
    if (launched && ball.y < BALL_LOW_Y) return;
  ...
  function gameLoop(timestamp) {
    ...
    // Colisión con ladrillos (máximo uno por frame)
  ...
  layoutStage();
  resetGameState();
  console.log('✅ Juego listo (colisión corregida)');
}
