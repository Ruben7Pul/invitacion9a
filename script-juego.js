...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ============================================================
  // 🌀 PARALLAX POR CONTENEDORES (más ligero)
  // ============================================================
  ...
  if (!appInner) {
    ...
    `;
    // Mover todos los hijos de #app a appInner
  ...
  // Elementos contenedores a mover
  const portalInner = document.querySelector('.portal-inner');
  // appInner ya está definido
