...
// ============================================================
// 1. DETECCIÓN DE HORA DEL DÍA (para temas dinámicos)
// ============================================================
...
function rellenarDatos(config) {
  ...
  // Enlace del libro de firmas (genérico)
...
// ============================================================
// 4. CALENDARIO (generación de días de octubre 2026)
// ============================================================
...
// ============================================================
// 5. MARCAR DÍA ACTUAL EN CALENDARIO (brillo rosa si es octubre 2026)
// ============================================================
...
// ============================================================
// 6. VARIABLES GLOBALES PARA INTERVALOS (limpieza)
// ============================================================
let intervaloItinerario = null;
let intervaloContador = null;

// ============================================================
// 7. BRILLO ACTIVO EN ITINERARIO (resalta evento actual)
// ============================================================
...
// ============================================================
// 8. EVENTOS DEL CALENDARIO (botones "Añadir" a Google Calendar)
// ============================================================
...
function agregarACalendario(evento, config) {
  // Usar la API nativa si existe, si no, abrir Google Calendar
  if ('calendar' in navigator) {
    ...
    // Fallback: abrir Google Calendar
...
// ============================================================
// 9. CONTADOR CIRCULAR CON ANILLO SVG
// ============================================================
function actualizarContador() {
  ...
  if (diff <= 0) {
    document.querySelectorAll('.countdown-unit .num').forEach(el => el.textContent = '0');
    return;
  }
  ...
  if (msgEl) {
    let mensaje = '';
    if (dias > 30) mensaje = 'Falta un poco más de un mes...';
    else if (dias > 7) mensaje = 'La espera se hace corta.';
    else if (dias > 1) mensaje = '¡Ya casi llega!';
    else if (dias === 1) mensaje = '¡Mañana es el gran día!';
    else if (dias === 0 && horas > 6) mensaje = '¡Hoy es el día!';
    else if (dias === 0 && horas > 1) mensaje = '¡En unas horas comienza!';
    else if (dias === 0 && horas >= 0) mensaje = '¡El momento está aquí!';
...
function initContadorCircular(config) {
  ...
  // Crear las 4 unidades dinámicamente
  container.innerHTML = `
  ...
  // Añadir el SVG con los círculos a cada unidad
...
// ============================================================
// 10. LIMPIEZA DE INTERVALOS AL CERRAR LA PÁGINA
// ============================================================
...
// ============================================================
// 11. INICIO PRINCIPAL (DOMContentLoaded)
// ============================================================
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ============================================================
  // 12. GESTIÓN DE LA REJA (PORTAL) Y APP
  // ============================================================
  ...
  // ============================================================
  // 15. OBSERVADOR DE SECCIONES (animaciones al hacer scroll)
  // ============================================================
